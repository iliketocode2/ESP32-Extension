...
import { SerialReplManager, SerialPortInfo } from './serialRepl';

let panel: vscode.WebviewPanel | undefined;
const serialManager = new SerialReplManager();
...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('spike-serial-repl.open', () => {
            if (panel) {
                panel.reveal();
                return;
            }
